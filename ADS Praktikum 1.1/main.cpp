...
int main(void)
{
	...
	if (MyList3.test())
		...
		List Liste1, Liste2, Liste3, Liste4, Liste5;
		...
		cout << "Liste3 " << Liste3 << " und Länge: " << get_AnzahlNodes(Liste3) << endl << endl;
		cout << "Liste4 " << Liste4 << " und Länge: " << get_AnzahlNodes(Liste3) << endl << endl;
		cout << "Liste5 " << Liste5 << " und Länge: " << get_AnzahlNodes(Liste3) << endl << endl;
		...
		cout << "Liste3 " << Liste3 << " und Länge jetzt: " << get_AnzahlNodes(Liste3) << endl << endl;
		cout << "Liste4 " << Liste4 << " und Länge jetzt: " << get_AnzahlNodes(Liste4) << endl << endl;
		cout << "Liste5 " << Liste5 << " und Länge jetzt: " << get_AnzahlNodes(Liste5) << endl << endl;
		...
		List listfront, listfront2, listback3, listback4;
		...
		cout << "Liste vorher " << listfront << " und Länge " << get_AnzahlNodes(listfront) << endl << endl;
		cout << "Zu einfügende Liste vorher " << listfront2 << " und Länge: " << get_AnzahlNodes(listfront2) << endl << endl;

		listfront.insertFront(listfront2);

		cout << "Liste mit eingefügter Liste: " << listfront << " und Länge jetzt: " << get_AnzahlNodes(listfront) << endl << endl;

		if (get_AnzahlNodes(listfront2) == 0) {
			cout << "Länge von Listfront2: " << get_AnzahlNodes(listfront2) << endl << endl;
		}
		else {
		...
		cout << "Liste vorher " << listback3 << " und Länge " << get_AnzahlNodes(listback3) << endl << endl;
		cout << "Zu einfügende Liste vorher " << listback4 << " und Länge: " << get_AnzahlNodes(listback4) << endl << endl;

		listback3.insertBack(listback4);

		cout << "Liste mit eingefügter Liste: " << listback3 << " und Länge jetzt: " << get_AnzahlNodes(listback3) << endl << endl;

		if (get_AnzahlNodes(listback4) == 0) {
			cout << "Länge von Listfront2: " << get_AnzahlNodes(listback4) << endl << endl;
		}
		else {
			cout << "Es liegt ein Fehler vor" << endl << endl;
		}
		...
		cout << "listfront " << listfront << "und die Länge: " << get_AnzahlNodes(listfront) << endl << endl;
		cout << "listback " << listback3 << "und die Länge: " << get_AnzahlNodes(listback3) << endl << endl;

		//operator +
		listfront = listfront + listback3;
		cout << "Liste jetzt " << listfront << "und die Länge: " << get_AnzahlNodes(listfront) << endl << endl;
		if (listfront.test())
			cout << "listfront: Zeiger OK\n\n";
		else
			cout << "listfront: Zeiger ******Error\n\n";
		...
		//für getFront()
		L1.insertFront(12);
		cout << "L1: " << L1 << " Länge: " << get_AnzahlNodes(L1) << endl << endl;
		L1.getFront(var);
		if (var == 12) {
			cout << "Zahl 12 gefunden und entfernt." << endl << endl;
			cout << "L1 danach " << L1 << "Länge: " << get_AnzahlNodes(L1) << endl << endl;
		}
		else {
