...
int EdgeWeightedGraph::degree(EdgeWeightedGraph G, int v) {
	return G.getAdj(v).size();
}

int EdgeWeightedGraph::maxDegree(EdgeWeightedGraph G) {
	int max = 0;
...
double EdgeWeightedGraph::averageDegree(EdgeWeightedGraph G) {
